...
function renderLineup() {
  try {
    ...
    if (title) {
      if (state.upcomingFilter === '21') title.textContent = `Lineup · ${visibleShows.length} scheduled next 3 weeks`;
      else if (state.upcomingFilter === 'archived') title.textContent = `Archived shows · ${visibleShows.length}`;
